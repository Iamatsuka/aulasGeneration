...
public class StoreMakeDiference {
    public static void main(String[] args) {
        int categ = 0, subcateg;
        Scanner leia = new Scanner(System.in);

        Cliente cliente = Inicializacao.dadosCliente();
        Produto[][] prod = Inicializacao.inicializaProdutos();
        ...
        Inicializacao.imprimeCompra(cliente, prod);
    }
}
