...
public class Inicializacao {
    public static Cliente dadosCliente(){
        ...
        System.out.println("Bem Vindes a StoreMakeDiference!\n");
    ...
    public static Produto[][] inicializaProdutos(){
        ...
        produtos[0][2] = new Produto(1,29.90,0,"Lip Tint","Boca Rosa Tint by Payot e um batom corante vermelho para ser usado nos labios e bochechas. Sua cor com alta fixacao e transparencia permanece por todo o dia, dando um aspecto de saude e naturalidade a pele. Boca Rosa Tint by Payot e você naturalmente linda.");

        produtos[1][0] = new Produto(2,9.90,0,"Lapis Kajal","E altamente pigmentado, com textura super macia, cremosa e secagem rapida.\nE altamente pigmentado, com textura super macia, cremosa e secagem rapida.");
        produtos[1][1] = new Produto(2,10.90,0,"Mascara de cilios","A Mascara para Cilios Define e Alonga, foi criada especialmente para definir e alongar cilios, com seu exclusivo aplicador ela ira proporcionar um acabamento surpreendente e natural.");
        produtos[1][2] = new Produto(2,24.90,0,"Paleta de Sombras","Sao tons de azul, rosa, neutros, dourado, preto, muitas opcoes e infinitas combinacoes para destacar o seu olhar. Alem disso, as sombras sao pigmentadas e macias e sua embalagem e compacta.");
        ...
        produtos[2][2] = new Produto(3,69.90,0,"Paleta de Blush","O produto realca as macas do rosto, colorindo de forma natural. Atribui aparencia saudavel, caracteristica " +
        ...
        for(int i=0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                if(prod[i][j].getQtde() != 0) {
                    System.out.println("Produto: " + prod[i][j].getNome());
                    System.out.println("Valor: " + prod[i][j].getValor());
